...
export default function (state = initialNavState, action) {
    switch (action.type) {
        case TYPES.NAV_MY_MAIN:
            return HomeNavigator.router.getStateForAction(NavigationActions.navigate({routeName: 'MyPage'}), state);
